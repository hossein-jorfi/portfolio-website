...
export const TelegramIcon = ({ className, ...rest }: { className: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="2.2em"
    height="2.2em"
  ...
  >
    ...
    <path
      fill="url(#a)"
      d="M22.007 35.25 39.022 25 27.011 37.5l10.535 8.275c1.887.83 2.574-.899 2.574-.899l4.825-24.501s.082-.625.045-.75c-.344-1.168-2.228-.325-2.227-.324L15.206 30.188s-1.304.449-1.201 1.278c.103.83 1.167 1.209 1.167 1.209l6.837 2.575"
    />
    <linearGradient
      id="b"
      x1={29.5}
    ...
    <path
      fill="url(#b)"
      d="M45.949 19.343c-.23-.784-.859-1.269-1.727-1.33-.175-.013-1.159.027-1.823.365l-.003-.007-27.515 10.872c-.885.304-1.861 1.023-1.881 2.087a1.78 1.78 0 0 0 .014.26c.173 1.4 1.654 1.968 1.807 2.021l6.377 2.402c.49 1.575 2.108 6.774 2.456 7.886.234.744.62 1.709 1.327 1.973a1.733 1.733 0 0 0 1.81-.319l3.903-3.89 6.235 4.897a.937.937 0 0 0 .215.129c.517.228.976.31 1.367.31.409 0 .745-.089.998-.193 1.067-.438 1.494-1.447 1.54-1.561.022-.057.04-.116.052-.176l4.835-24.564c.111-.836.051-1.033.013-1.162zM23.195 35.701l9.872-5.947-6.775 7.053a.954.954 0 0 0-.229.442l-1.006 4.43-1.862-5.978zm20.768-15.513-4.799 24.37c-.057.098-.2.311-.413.398-.179.073-.412.055-.694-.053l-9.559-7.507 11.245-11.704a.998.998 0 0 0-1.236-1.548l-16.601 10-6.389-2.406a1.313 1.313 0 0 1-.481-.323 1.89 1.89 0 0 1 .537-.296L43.131 20.23c.017-.006.033-.014.05-.021.251-.11.59-.192.803-.205-.01.1-.021.183-.021.184z"
    />
    <linearGradient
      id="c"
      x1={32}
    ...
    <path
      fill="url(#c)"
      d="M32 58C17.663 58 6 46.336 6 32S17.663 6 32 6s26 11.664 26 26-11.663 26-26 26zm0-50C18.767 8 8 18.767 8 32s10.767 24 24 24 24-10.767 24-24S45.233 8 32 8z"
    />
  </svg>
);
